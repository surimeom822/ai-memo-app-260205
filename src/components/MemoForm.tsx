              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <textarea
                    ...
                    className="placeholder-gray-400 text-gray-900 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none font-mono text-sm"
                ...
                {/* 프리뷰 영역 */}
                <div
                  className="border border-gray-300 rounded-lg p-3 overflow-auto bg-gray-50"
